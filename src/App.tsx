...
function App() {
  ...
  // Track scroll progress for 3D scene effects
  useEffect(() => {
    const onScroll = () => {
  ...
  useGSAP(
    () => {
      const ctx = gsap.context(() => {
        ...
        // Subtle parallax fade of the background canvas across the page
  ...
  return (
    <div className="app" data-theme={theme}>
      ...
      <SpaceCanvas theme={theme} scrollProgress={scrollProgress} />
      <div className="page-shell" ref={scopeRef}>
        <header className="nav">
          <div className="brand">KV • Orbit</div>
          <nav>
            <a href="#work">Work</a>
